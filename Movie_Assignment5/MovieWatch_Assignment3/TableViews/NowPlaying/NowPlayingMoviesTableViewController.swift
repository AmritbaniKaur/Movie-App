...
class NowPlayingMoviesTableViewController: UITableViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        tableView.register(NowPlayingMoviesCell.self, forCellReuseIdentifier: "cellidnowplaying")
    ...
    {
        let url = URL(string: "https://api.themoviedb.org/3/movie/now_playing?api_key=2141436cc1d11d1aa9f276be95e352c4")
    ...
    {
        let cell = NowPlayingMoviesCell(style: .default, reuseIdentifier: "cellidnowplaying")
        //print("Hits here!")
