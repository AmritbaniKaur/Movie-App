...
class UpcomingMoviesTableViewController: UITableViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        tableView.register(UpcomingMoviesCell.self, forCellReuseIdentifier: "cellidupcoming")
    ...
    {
        let url = URL(string: "https://api.themoviedb.org/3/movie/upcoming?api_key=2141436cc1d11d1aa9f276be95e352c4")
    ...
    {
        let cell = UpcomingMoviesCell(style: .default, reuseIdentifier: "cellidupcoming")
        //print("Hits here!")
