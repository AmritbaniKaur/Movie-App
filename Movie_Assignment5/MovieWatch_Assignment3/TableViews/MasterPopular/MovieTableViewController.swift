...
class MovieTableViewController: UITableViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        tableView.register(MovieTableViewCell.self, forCellReuseIdentifier: "cellidmaster")
    ...
    {
        let cell = MovieTableViewCell(style: .default, reuseIdentifier: "cellidmaster")
        //print("Hits here!")
        ...
        self.downloadJSON
        {
            ...
            //print("favArray in cellForRowAt in MovieTable: ", self.favArray)
