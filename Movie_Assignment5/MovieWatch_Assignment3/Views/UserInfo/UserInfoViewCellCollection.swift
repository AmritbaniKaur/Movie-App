//
//  UserInfoViewCellCollection.swift
//  MovieWatch_Assignment3
//
//  Created by Amritbani Sondhi on 4/15/18.
//  Copyright © 2018 Amritbani Sondhi. All rights reserved.
//

import UIKit

class UserInfoViewCellCollection: UIView {
    ...
    */
    ...
    {
        let img = UIImageView()
        img.image = UIImage(named: "Movie_6")
    ...
    */
    ...
    func setupViews()
    {
        ...
        //let stackView = createStackView(views: [nameTextField, emailTextField, passwordTextField, submitButton, cancelButton])
        let stackView = createStackView(views: [nameTextField, submitButton, cancelButton])
